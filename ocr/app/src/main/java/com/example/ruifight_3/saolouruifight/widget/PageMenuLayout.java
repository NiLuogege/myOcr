...
import com.stx.xhb.pagemenulibrary.CustomViewPager;
...
/**
 * Created by RuiFight-3 on 2019/7/24.
...
public class PageMenuLayout<T> extends RelativeLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.stx.xhb.pagemenulibrary.R.styleable.PageMenuLayout);
        if (typedArray != null) {
            mRowCount = typedArray.getInteger(com.stx.xhb.pagemenulibrary.R.styleable.PageMenuLayout_pagemenu_row_count, DEFAULT_ROW_COUNT);
            mSpanCount = typedArray.getInteger(com.stx.xhb.pagemenulibrary.R.styleable.PageMenuLayout_pagemenu_span_count, DEFAULT_SPAN_COUNT);
            typedArray.recycle();
        }
